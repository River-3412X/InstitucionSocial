    ...
    <div class="row">
        <div class="col l4 offset-l1 center-align" style="position:absolute; top:5%;"id="frm_registrar">
            ...
            <form action="control1.php" method="post" accept-charset="utf-8">            
                ...
                <div class="input-field "> 
                    <input type="text" name="telefono" value="" placeholder="" pattern="[0-9]{10}" required="required">
                    <label for="txtnumero"> Telefóno <small>(10 dígitos)</small>:</label>
                </div>
                <div class="input-field "> 
                    <input type="date" name="fechabautizo" value="" placeholder="" id="date" required="required">
                    <label for="txtfecha"> Fecha Bautizo:</label><br>
                </div>
                <div class="input-field">
        ...
        <div class="col l4 offset-l1 center-align" style="position:absolute; top:130%;">
            <table>
                <h5 class="blue-text left-align" >LISTADO DE BAUTIZOS</h5><br><br>
                <thead>
                    <tr>
        ...
        <div class="col l4 offset-l1 center-align" style="position:absolute; top:5%;" id="frm_actualizar">
            ...
            <form action="control1.php" method="post" accept-charset="utf-8">
                ...
                <div class="input-field "> 
                    ...
                    <label for="txttel"> Telefóno <small>(10 dígitos)</small>:</label>
                </div>
                <div class="input-field "> 
