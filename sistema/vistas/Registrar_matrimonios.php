                ...
                <div class="tab-container p-4" id="tab_container">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtnombre" placeholder="Nombre de la Novia" required="required" class="form-control" id="nombre_novia">
                                </div>
                                <div class="form-group">
                                    <label for="txtapellido">Apellidos Novia</label><br>
                                    <input type="text" name="txtapellido" placeholder="Apellidos de la Novia" required="required" class="form-control" id="apellidos_novia">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtnom" placeholder="Nombre del Novio" required="required" class="form-control" id="nombre_novio">
                                </div>

                                <div class="form-group">
                                    <label for="txtape">Apellidos Novio</label>
                                    <input type="text" name="txtape" placeholder="Apellidos del Novio" class="form-control" id="apellidos_novio">
                                </div>
                                <div class="input-file">
                    ...
                    <div class="tab-container-item" id="contenido_tres">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="txtnmad" placeholder="Nombre de la Madrina" required="required" class="form-control" id="nombre_madrina">
                        </div>
                        <div class="form-group ">
                            <label for="txtamad"> Apellidos Madrina</label>
                            <input type="text" name="txtamad" placeholder="Apellidos de la Madrina" required="required" class="form-control" id="apellidos_madrina">

                        </div>
                        <div class="form-group ">
                            <label for="txtnpad"> Nombre Padrino</label>
                            <input type="text" name="txtnpad" placeholder="Nombre del Padrino" required="required" class="form-control" id="nombre_padrino">

                        </div>
                        <div class="form-group ">
                            <label for="txtapad"> Apellidos Padrino</label>
                            <input type="text" name="txtapad" placeholder="Apellidos del Padrino" required="required" class="form-control" id="apellidos_padrino">
                    ...
                    <div class="tab-container-item" id="contenido_cuatro">
                        ...
                        <div class="from-group">
                            ...
                            <input id="fecha_boda" type="date" name="txtfecha" placeholder="" required="required" class="form-control" min="<?php
                                                                                                                            $fecha = Date('d-m-Y');
                        ...
                        <div class="form-group ">
                            ...
                            <input type="date" name="txtfecha_cita" class="form-control" id="date" min="<?php echo date("Y-m-d"); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="txtmotivo" placeholder="Ingresa el Motivo de la Cita" id="motivo" class="form-control">
                        </div>
                        <div class="progress my-2" id="progress_bar" style="display:none">
                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" style="width: 0%" aria-valuemin="0" aria-valuemax="100" id="progress_bar_content">
                                cargando: 0%
                            </div>
                        </div>        
