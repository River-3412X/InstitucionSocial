...
<script src="<?php echo DOMINIO; ?>/public/assets/js/registrar_comunion.js" type="text/javascript"></script>
...
<div class="col s4 offset-s4 center-align" id="frm_registrar">
    <h5 class="blue-text">REGISTRAR ALUMNO PRIMERA COMUNIÓN</h5><br><br>
        ...
        <div class="input-file">
            ...
            <div class="input-file">
                ...
                <div class="input-file">
                    ...
                    <input type="file" name="febautizo" id="comprobante" accept="application/pdf">
                    <label for="comprobante" id="labelcomprobante" class="nombre-archivo">Selecciona un archivo
                        PDF</label>

                    <div class="form-group">
                        <label for="txtNivel">id usuario </label>
                        <input type="text" name="txtNivel" placeholder="Nivel del alumno" required="required"
                            class="form-control" id="nivel_alumno">
                    </div>
